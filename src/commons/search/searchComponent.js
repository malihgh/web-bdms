      ...
      >
        ...
        <div
          style={{
            display: 'flex',
            flexDirection: 'column',
            flex: this.state.accordionIdx === 0? '1 1 100%': null,
            overflow: 'hidden',
          }}
        >
          <div
            ...
            onClick={
              () => {
                this.setState({
                  accordionIdx: this.state.accordionIdx === 0? 1: 0
                })
              }
            }
          >
            <Icon
              name={`caret ${this.state.accordionIdx === 0? 'down': 'right'}`}
            /> <span 
            className='linker'>
              <TranslationText
          ...
          <div
            style={{
              flex: '1 1 100%',
              overflow: 'auto',
              display: this.state.accordionIdx === 1? 'none': null
            }}
          >
            <Form
              size='tiny'
        ...
        <div
          style={{
            display: 'flex',
            flexDirection: 'column',
            flex: this.state.accordionIdx === 1? '1 1 100%': null,
            overflow: 'hidden',
          }}
        >
          <div
            ...
            onClick={
              () => {
                this.setState({
                  accordionIdx: this.state.accordionIdx === 1? 0: 1
                });
              }
            }
          >
            <Icon
              name={`caret ${this.state.accordionIdx === 1? 'down': 'right'}`}
            /> <span 
            className='linker'>
              <TranslationText
          ...
          <div
            style={{
              flex: '1 1 100%',
              overflow: 'auto',
              display: this.state.accordionIdx === 0? 'none': null
            }}
          >
            <Form
              size='tiny'
                ...
                this.isVisible('layer.organic_component') ?
                  <Form.Field>
                    ...
                    <DomainDropdown
                      onSelected={(selected) => {
                        this.props.setFilter(
                          'layer_organic_component', selected.id
                        );
                      }}
                      reset={false}
                      schema='mlpr108'
                ...
                this.isVisible('layer.grain_size_1') ?
                  <Form.Field>
                    ...
                    <DomainDropdown
                      onSelected={(selected) => {
                        this.props.setFilter(
                          'layer_grain_size_1', selected.id
                        );
                      }}
                      reset={false}
                      schema='mlpr109'
                ...
                this.isVisible('layer.grain_size_2') ?
                  <Form.Field>
                    ...
                    <DomainDropdown
                      onSelected={(selected) => {
                        this.props.setFilter(
                          'layer_grain_size_2', selected.id
                        );
                      }}
                      reset={false}
                      schema='mlpr109'
                ...
                this.isVisible('layer.grain_granularity') ?
                  <Form.Field>
                    ...
                    <DomainDropdown
                      onSelected={(selected) => {
                        this.props.setFilter(
                          'layer_grain_granularity', selected.id
                        );
                      }}
                      reset={false}
                      schema='mlpr115'
                ...
                this.isVisible('layer.further_properties') ?
                  <Form.Field>
                    ...
                    <DomainDropdown
                      onSelected={(selected) => {
                        this.props.setFilter(
                          'layer_further_properties', selected.id
                        );
                      }}
                      reset={false}
                      schema='mlpr117'
                ...
                this.isVisible('layer.uscs_determination') ?
                  <Form.Field>
                    ...
                    <DomainDropdown
                      onSelected={(selected) => {
                        this.props.setFilter(
                          'layer_uscs_determination', selected.id
                        );
                      }}
                      reset={false}
                      schema='mcla104'
