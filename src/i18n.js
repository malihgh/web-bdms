...
let resources = {
  ...
  it: {
    common: {
      "title": "BMS",
      "start": "Questa pagina � in Italiano",
      'yes': 'S�',
      'no': 'No',
    ...
    borehole_form: {
      ...
      'srs': 'SRS',
      'qt_location': 'Qualit� coordinate',
      'elevation_z': 'Altitudine (msl)',
      'hrs': 'HRS',
      'qt_elevation': 'Qualit� elevazione',
      'country': 'Paese',
      'canton': 'Cantone',
      'city': 'Citt�',
      'address': 'Indirizzo',
      ...
      'qt_bore_inc_dir': 'Qualit� Inclin. / Direz.',
      'length': 'Profondit� (MD) (m)',
      'qt_length': 'Qualit� profondit�',
    ...
    layer_form: {
      'loading_fetch': 'Caricando un layer esistente..',
      'creation_fetch': 'Preparando un layer nuovo..',
      'depth': 'Profondit�',
      'depth_from': 'Top MD (m)',
      'depth_to': 'Base MD (m)',
      ...
      'qt_description': 'Qualit� descrizione',
